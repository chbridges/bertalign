...
* **Updated requirements.txt and setup.py**<br/>You don't have to install dependencies manually when running 'pip install git+https://github.com/chbridges/bertalign.git', but you might want to install PyTorch before if you don't use CUDA 12.1.
