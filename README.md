...
* **Remove sentence splitting** This step can currently be handled by the user and overridden using the flag 'is_split=True'. Removing it entirely gets rid of the [sentence-splitter](https://github.com/mediacloud/sentence-splitter) dependency.
